        ...
        <div class="menu-container">
            <div class="menu">
                ...
                <div class="menu-group">
                    <?php
                    // $conn = mysqli_connect("localhost","root","","food-ordering-system") or die("Connection Failed");
                    $sql = "SELECT * FROM product where type = 'Bengali' and available = 1";
                ...
                <div class="menu-group">
                    <?php
                    // $conn = mysqli_connect("localhost","root","","food-ordering-system") or die("Connection Failed");
                    $sql = "SELECT * FROM product where type = 'Sub Continental' and available = 1";
                    $result = mysqli_query($conn, $sql) or die("Query Failed");
                ...
                <div class="menu-group">
                    <?php
                    // $conn = mysqli_connect("localhost","root","","food-ordering-system") or die("Connection Failed");
                    $sql = "SELECT * FROM product where type = 'Western' and available = 1";
                    $result = mysqli_query($conn, $sql) or die("Query Failed");
